...
begin
  ...
  AssertEquals('Shuffle:Sub5 X failed ', 2, abf3.X);
  AssertEquals('Shuffle:Sub6 Y failed ', 2, abf3.Y);
  AssertEquals('Shuffle:Sub7 Z failed ', 2, abf3.Z);
  AssertEquals('Shuffle:Sub8 W failed ', 2, abf3.W);
  abf3 := abf1.Swizzle(swZZZZ);
  AssertEquals('Shuffle:Sub9 X failed ',  3, abf3.X);
  AssertEquals('Shuffle:Sub10 Y failed ', 3, abf3.Y);
  AssertEquals('Shuffle:Sub11 Z failed ', 3, abf3.Z);
  AssertEquals('Shuffle:Sub12 W failed ', 3, abf3.W);
  abf3 := abf1.Swizzle(swWWWW);
  AssertEquals('Shuffle:Sub13 X failed ', 4, abf3.X);
  AssertEquals('Shuffle:Sub14 Y failed ', 4, abf3.Y);
  AssertEquals('Shuffle:Sub15 Z failed ', 4, abf3.Z);
  AssertEquals('Shuffle:Sub16 W failed ', 4, abf3.W);
  abf3 := abf1.Swizzle(swXYZW);
  AssertEquals('Shuffle:Sub17 X failed ', 1, abf3.X);
  AssertEquals('Shuffle:Sub18 Y failed ', 2, abf3.Y);
  AssertEquals('Shuffle:Sub19 Z failed ', 3, abf3.Z);
  AssertEquals('Shuffle:Sub20 W failed ', 4, abf3.W);
  abf3 := abf1.Swizzle(swXZYW);
  AssertEquals('Shuffle:Sub21 X failed ', 1, abf3.X);
  AssertEquals('Shuffle:Sub22 Y failed ', 3, abf3.Y);
  AssertEquals('Shuffle:Sub23 Z failed ', 2, abf3.Z);
  AssertEquals('Shuffle:Sub24 W failed ', 4, abf3.W);
  abf3 := abf1.Swizzle(swZYXW);
  AssertEquals('Shuffle:Sub21 X failed ', 3, abf3.X);
  AssertEquals('Shuffle:Sub22 Y failed ', 2, abf3.Y);
  AssertEquals('Shuffle:Sub23 Z failed ', 1, abf3.Z);
  AssertEquals('Shuffle:Sub24 W failed ', 4, abf3.W);
  abf3 := abf1.Swizzle(swZXYW);
  AssertEquals('Shuffle:Sub25 X failed ', 3, abf3.X);
  AssertEquals('Shuffle:Sub26 Y failed ', 1, abf3.Y);
  AssertEquals('Shuffle:Sub27 Z failed ', 2, abf3.Z);
  AssertEquals('Shuffle:Sub28 W failed ', 4, abf3.W);
  abf3 := abf1.Swizzle(swYXZW);
  AssertEquals('Shuffle:Sub29 X failed ', 2, abf3.X);
  AssertEquals('Shuffle:Sub30 Y failed ', 1, abf3.Y);
  AssertEquals('Shuffle:Sub31 Z failed ', 3, abf3.Z);
  AssertEquals('Shuffle:Sub32 W failed ', 4, abf3.W);
  abf3 := abf1.Swizzle(swYZXW);
  AssertEquals('Shuffle:Sub33 X failed ', 2, abf3.X);
  AssertEquals('Shuffle:Sub34 Y failed ', 3, abf3.Y);
  AssertEquals('Shuffle:Sub35 Z failed ', 1, abf3.Z);
  AssertEquals('Shuffle:Sub36 W failed ', 4, abf3.W);
  abf3 := abf1.Swizzle(swWXYZ);
  AssertEquals('Shuffle:Sub37 X failed ', 4, abf3.X);
  AssertEquals('Shuffle:Sub38 Y failed ', 1, abf3.Y);
  AssertEquals('Shuffle:Sub39 Z failed ', 2, abf3.Z);
  AssertEquals('Shuffle:Sub40 W failed ', 3, abf3.W);
  abf3 := abf1.Swizzle(swWXZY);
  AssertEquals('Shuffle:Sub41 X failed ', 4, abf3.X);
  AssertEquals('Shuffle:Sub42 Y failed ', 1, abf3.Y);
  AssertEquals('Shuffle:Sub43 Z failed ', 3, abf3.Z);
  AssertEquals('Shuffle:Sub44 W failed ', 2, abf3.W);
  abf3 := abf1.Swizzle(swWZYX);
  AssertEquals('Shuffle:Sub45 X failed ', 4, abf3.X);
  AssertEquals('Shuffle:Sub46 Y failed ', 3, abf3.Y);
  AssertEquals('Shuffle:Sub47 Z failed ', 2, abf3.Z);
  AssertEquals('Shuffle:Sub48 W failed ', 1, abf3.W);
  abf3 := abf1.Swizzle(swWZYX);
  AssertEquals('Shuffle:Sub45 X failed ', 4, abf3.X);
  AssertEquals('Shuffle:Sub46 Y failed ', 3, abf3.Y);
  AssertEquals('Shuffle:Sub47 Z failed ', 2, abf3.Z);
  ...
  AssertEquals('Shuffle:Sub49 X failed ', 4, abf3.X);
  AssertEquals('Shuffle:Sub50 Y failed ', 3, abf3.Y);
  AssertEquals('Shuffle:Sub51 Z failed ', 1, abf3.Z);
  AssertEquals('Shuffle:Sub52 W failed ', 2, abf3.W);
  abf3 := abf1.Swizzle(swWYXZ);
  AssertEquals('Shuffle:Sub53 X failed ', 4, abf3.X);
  AssertEquals('Shuffle:Sub54 Y failed ', 2, abf3.Y);
  AssertEquals('Shuffle:Sub55 Z failed ', 1, abf3.Z);
  AssertEquals('Shuffle:Sub56 W failed ', 3, abf3.W);
  abf3 := abf1.Swizzle(swWYZX);
  AssertEquals('Shuffle:Sub53 X failed ', 4, abf3.X);
  AssertEquals('Shuffle:Sub54 Y failed ', 2, abf3.Y);
  AssertEquals('Shuffle:Sub55 Z failed ', 3, abf3.Z);
  AssertEquals('Shuffle:Sub56 W failed ', 1, abf3.W);
end;
